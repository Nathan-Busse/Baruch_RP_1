...
Baruch_SPIDevice *spi_dev = NULL; // new Baruch_SPIDevice(SPIDEVICE_CS);

#define I2C_ADDRESS 0x5D
Baruch_I2CDevice *i2c_dev = new Baruch_I2CDevice(I2C_ADDRESS);
...
void setup() {
  ...
  Baruch_BusIO_Register id_reg =
      Baruch_BusIO_Register(i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, 0x0F);
  uint8_t id = 0;
  id_reg.read(&id);
