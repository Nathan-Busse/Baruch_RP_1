...
public:
  ...
  Baruch_GenericDevice *createDevice() {
    return new Baruch_GenericDevice(this, uart_read, uart_write, uart_readreg,
                                      uart_writereg);
  }
};
...
void setup() {
  ...
  Baruch_GenericDevice *device = uart.createDevice();
  device->begin();

  // Create register object for IOIN
  Baruch_BusIO_Register ioin_reg(device,
  ...
  Baruch_BusIO_RegisterBits version_bits(
