#ifndef Baruch_SPIDevice_h
#define Baruch_SPIDevice_h
...
class Baruch_SPIDevice {
public:
#ifdef BUSIO_HAS_HW_SPI
  Baruch_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
...
#endif
  Baruch_SPIDevice(int8_t cspin, int8_t sck, int8_t miso, int8_t mosi,
